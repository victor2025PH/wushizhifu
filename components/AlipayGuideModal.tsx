                ...
                {showVideo ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full mb-6 flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all active:scale-[0.98]"
                    >
              ...
              {!showVideo && (
                <div className="p-4 border-t border-gray-100 space-y-2">
                  <button
                    ...
                    className="w-full bg-blue-600 text-white py-3 px-4 rounded-2xl font-semibold shadow-lg hover:bg-blue-700 transition-all active:scale-[0.98] flex items-center justify-center space-x-2"
                  >
