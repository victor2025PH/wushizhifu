...
BUTTON_HELP: Dict[str, Dict[str, str]] = {
    ...
    "设置全局加价": {
        "title": "➕ 设置全局加价",
        "description": "设置全局默认加价值，影响所有未配置独立设置的群组",
        "usage": (
            "📖 <b>使用方法：</b>\n\n"
            "1. 在全局管理菜单中点击「➕ 设置全局加价」\n"
            "2. 输入加价值（例如：0.5）\n"
            "3. 系统确认设置成功\n"
            "4. 所有未配置独立设置的群组将使用此加价值\n\n"
            "💡 <i>提示：加价值可以是正数（加价）或负数（降价）</i>"
        ),
        "features": (
            "✨ <b>功能特点：</b>\n"
            "• 全局默认加价设置\n"
    ...
    "设置全局地址": {
        "title": "📍 设置全局地址",
        "description": "设置全局默认 USDT 收款地址",
        "usage": (
            "📖 <b>使用方法：</b>\n\n"
            "1. 在全局管理菜单中点击「📍 设置全局地址」\n"
            "2. 输入 USDT 收款地址\n"
            "3. 系统确认设置成功\n"
            "4. 所有未配置独立地址的群组将使用此地址\n\n"
            "💡 <i>提示：地址格式需符合 USDT 地址规范</i>"
        ),
        "features": (
            "✨ <b>功能特点：</b>\n"
            "• 全局默认地址设置\n"
